...
function Room({offers, reviews}: RoomProps): JSX.Element {
  ...
  if (property) {
    const {images, type, isPremium, title, rating, bedrooms, maxAdults, price, goods, host, description, isFavorite, city} = property;
        ...
        <Layout>
          <main className="page__main page__main--property">
            <section className="property">
              ...
              <Map className={'property__map'} city={city.location} offers={offers} selectedOffer={property}/>
            </section>
